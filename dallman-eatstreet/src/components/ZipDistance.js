...
class ZipDistance extends React.Component {
    ...
    render() {
        return (
            ...
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" placeholder="Zip Code #1"></input>
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Zip Code #2"></input>
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Distance"></input>
                </div>
                </div>
                <div class="row">
                <div class="col">
